...
class ProgrammingLanguage:
    ...
    def __repr__(self):
        ...
        return f"{self.name}, {self.typing} Typing, Reflection={self.reflection}, First appeared in {self.year}, uses pointer arithmetic = {self.pointer_arithmetic}"
    ...
    def is_pointer_arithmetic(self):
        """Determine if a programming language uses pointer arithmetic """
        if self.pointer_arithmetic == "Yes":
            return True
